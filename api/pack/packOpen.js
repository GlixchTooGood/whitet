...
const main = async (req) => {
    ...
    const user = Users.findOne({username:req.session.username}).populate('ownedBlooks.blook');
    if (!pack) {
    ...
    await user.save();
    return { success: true, blookEarned: earnedBlook };
}
module.exports = { main };